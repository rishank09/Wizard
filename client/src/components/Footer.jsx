...
const Footer = () => {
  ...
  Conjure spells to craft enchanting assignments, summon mystical images, and elevate your creative powers.
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    ...
                    <div>
                        <h2 className="font-semibold text-gray-800 mb-5">Subscribe to our website</h2>
                        <div className="text-sm space-y-2">
                            <p>The latest updates sent to your inbox .</p>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-8">
                Made with ❤️ by <a className="font-semibold">Rishnak Pandey</a>
            </p>
        </footer>
    )
}
