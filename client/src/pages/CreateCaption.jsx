...
const CreateCaption = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate a creative caption for ${input} for ${selectedCategory}`;
      ...
      <div className="min-h-screen bg-[#0f172a]/40 backdrop-blur-md p-4 sm:p-6 rounded-lg flex flex-wrap gap-6 justify-center">
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h1 className="text-lg font-semibold text-white">AI Caption Generator</h1>
            </div>

            <label className="block text-sm font-medium text-gray-300 mb-2">Explain</label>
            <input
            ...
            <label className="block text-sm font-medium text-gray-300 mt-5 mb-2">Choose From Option</label>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-lg font-semibold text-white">Generated Caption</h1>
          </div>
          ...
          {!content ? (
            <div className="flex-1 flex justify-center items-center">
              <div className="text-sm flex flex-col items-center gap-3 text-gray-400">
                ...
                <p>Enter Discription and click “Generate Caption” to get started.</p>
              </div>
            </div>
          ) : (
